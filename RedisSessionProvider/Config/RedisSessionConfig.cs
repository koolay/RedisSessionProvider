namespace RedisSessionProvider.Config
{
    ...
    public static class RedisSessionConfig
    {
        ...
        /// </summary>
        public static Action<HttpContextBase, Dictionary<string,byte[]>, string> RedisWriteFieldDel { get; set; }
        ...
        /// </summary>
        public static Action<HttpContextBase, string[], string> RedisRemoveFieldDel { get; set; }
